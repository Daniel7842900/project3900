              ...
              <select name = "assignee">
                  <?php
                      ...
                      while($wt4 = mysqli_fetch_assoc($records4)){
                        ...
                        $sqlAssignee = "SELECT User_First_Name, User_Last_Name
                                        FROM User
                  ...
                  <option value = "<?php echo $wt1['User_ID']?>"><?php echo $wt3['User_First_Name']." ".$wt3['User_Last_Name'] ?></option>
              ...
              if (isset($_POST['catCode']) && isset($_POST['catName'])){
                ...
                $runCatID = mysqli_query($con, $getCatID);
                  ...
                  while ($result = mysqli_fetch_assoc($runCatID)){
                    ...
                    $sqlAddProjCat = "INSERT INTO Proj_Cat (Project_Project_ID, Category_Category_ID) VALUES ('6', '$catID')";
              ...
              if (isset($_POST['catName1']) && isset($_POST['catCode1'])){
                ...
                if (isset($_POST['taskCode']) && isset($_POST['taskName']) && isset($_POST['taskStartDate']) && isset($_POST['taskEndDate']) && isset($_POST['taskBudget'])){
                  echo "hi";
                    ...
                    $changeTask = mysqli_query($con, "UPDATE Task SET Task_Name = '$taskName', Task_Code = '$taskCode', Task_Start_Date = '$taskStart', Task_End_Date = '$taskEnd', Task_Budget = '$taskBudget', User_User_ID = '$selectAssignee' WHERE Task_ID = '$del_id'");
