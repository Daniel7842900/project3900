...
<head>
  ...
  <script>
    ...
    var html = '<tr><td><input type = "text" placeholder="Task Code" name = "taskCode[]"><input type = "text" placeholder="Task Name" name = "taskName[]"></td><td><input type = "text" style = "display:none" ></td><td><input type = "text"></td><td> <input type ="text"></td><td> <input type ="text"></td></tr>';
  ...
  <script>
    $(function() {
    // HTML template of a row
    var html = '<tr><td><input type = "text" placeholder="New Category Code" name = "newCategoryCode"><input type = "text" placeholder="New Category Name" name = "newCategoryName"></td></tr>';
  ...
  <script>
    $(function() {
    // HTML template of a row
    var html = '<tr><td><input type = "text" placeholder="New Task Code" name = "newCategoryCode"><input type = "text" placeholder="New Task Name" name = "newCategoryName"></td></tr>';
	...
	<table id = "myTable">
		...
		<tr id = "category_row">
          <td> <?php echo $wt['Category_Code']. " " . $wt['Category_Name']; ?> 
            <input type = "button" name = "del" value="del"><button type="button" name="add" class = "add_row_task"> + </button>
              <button type="button" name="edit" class = "edit_category">edit </button>
			</td>
		...
		?>
            ...
            <tr>
              ...
              <button type="button" name="edit" class = "edit_task" > edit </button>
			</td>
		    <td>
		    <label>	
		    </label>
